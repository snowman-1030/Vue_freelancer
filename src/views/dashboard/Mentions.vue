...
<template>
  <div class="flex-1 p-2 md:p-6">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-2 md:py-8">
      <!-- Welcome Section -->
      <div class="mb-8 bg-white rounded-lg shadow-sm p-4 sm:p-6 sm:pt-4">
      ...
      <!-- Summary Cards -->
      <div class="mb-8">
        <div class="grid grid-cols-2 grid-rows-2 sm:grid-rows-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
          <!-- Total Mentions -->
          <Card
