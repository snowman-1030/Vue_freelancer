  ...
  <div class="flex-1 p-6">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <Alert class="mb-8 shadow-sm hover:shadow-md transition-all duration-200 border border-red-500/10 bg-gradient-to-br from-red-100/60 to-rose-100/60 rounded-lg flex items-center gap-3">
        <div class="flex items-center justify-center w-10 h-10 rounded-lg bg-gradient-to-br from-red-100/60 to-rose-100/60 border border-red-500/10">
          <AlertTriangle class="h-5 w-5 text-red-700" />
        </div>
        <div class="flex flex-col">
          <AlertTitle class="text-base font-semibold text-red-700">Attention</AlertTitle>
          <AlertDescription class="text-base text-red-700/80">
