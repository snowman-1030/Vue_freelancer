  ...
  <Card class="bg-white shadow-sm">
    <CardHeader>
      <div class="flex items-center gap-3 mb-6">
        ...
        <div>
          <CardTitle class="text-lg font-medium text-gray-700">Current Tracking Keywords</CardTitle>
          <p class="text-base text-gray-500">Manage your tracked keywords and phrases</p>
        </div>
      </div>
